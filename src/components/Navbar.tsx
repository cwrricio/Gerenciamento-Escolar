  ...
  return (
    <div className="flex items-center justify-between p-4">
      ...
      <div className="hidden md:flex items-center gap-2 text-xs  rounded-full ring-[1.5px] ring-gray-300 px-2 py-1">
        ...
        <input type="text" placeholder="Pesquisar" className="w-[200px] p-2 outline-none bg-transparent" />
      </div>
      ...
      <div className="flex items-center gap-6 justify-end w-full">
        ...
        <div className="bg-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer relative">
          <Image src="/announcement.png" alt="user" width={24} height={23} />
        ...
        <div className="flex flex-col">
          <span className="text-sx leading-3 font-medium">Emanuel</span>
